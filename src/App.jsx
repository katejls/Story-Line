...
var MALE_VILLAINS = ["Malakai","Thorne","Draven","Viktor","Cain","Soren","Nero","Dante","Azazel","Cyrus","Thanatos","Damien","Ragnar","Alaric","Mordecai","Fenrir","Scorpius","Obsidian","Lucien","Magnus","Severin","Cassius","Vladislav","Ambrose","Balthazar","Corvus","Lazarus","Drago","Hadeon","Morrigan","Rexford","Valek","Zephyrus","Abraxas","Erebus","Grimshaw","Callisto","Lucius","Darius","Saul","Caspian","Kraven","Malvolio","Tyrion","Vance","Sixtus","Vesper","Dorian","Kronus","Mephisto"];
var FEMALE_VILLAINS = ["Ravenna","Lilith","Morgana","Nyx","Bellatrix","Vesper","Lucrezia","Delilah","Isolde","Selene","Jezebel","Electra","Tempest","Sarai","Viper","Crimson","Raven","Medusa","Persephone","Hecate","Circe","Pandora","Lamia","Calypso","Sable","Morwenna","Desdemona","Agrippina","Carmilla","Ophidia","Seraphine","Nemesis","Lilura","Nocturna","Sirena","Morana","Eris","Vendetta","Malice","Salome","Azura","Kassandra","Xena","Nefertiti","Corvina","Mystique","Scylla","Hela","Ursula","Gothel"];
var NEUTRAL_VILLAINS = ["Vex","Wraith","Crimson","Raven","Obsidian","Tempest","Phoenix","Storm","Shadow","Onyx","Hex","Bane","Cipher","Spectre","Eclipse","Phantom","Havoc","Chaos","Jinx","Abyss","Hollow","Dagger","Blaze","Frost","Omen","Glitch","Venom","Zero","Nether","Sable"];
